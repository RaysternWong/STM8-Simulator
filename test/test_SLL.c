...
void test_sll_a(void){
  ...
  TEST_ASSERT_EQUAL_INT8(1, sll_a(instr));
...
void test_sll_shortmem(void){
  ...
  TEST_ASSERT_EQUAL_INT8(2, sll_shortmem(instr));
...
void test_sll_longmem(void){
  ...
  TEST_ASSERT_EQUAL_INT8(4, sll_longmem(instr));
...
void test_sll_x(void){
  ...
  TEST_ASSERT_EQUAL_INT8(1, sll_x(instr));
...
void test_sll_shortoff_x(void){
  ...
  TEST_ASSERT_EQUAL_INT8(2, sll_shortoff_x(instr));
...
void test_sll_longoff_x(void){
  ...
  TEST_ASSERT_EQUAL_INT8(4, sll_longoff_x(instr));
...
void test_sll_y(void){
  ...
  TEST_ASSERT_EQUAL_INT8(2, sll_y(instr)); 
  TEST_ASSERT_EQUAL_INT8(0x4C, MEM_READ_BYTE(0X102B) ); 
  TEST_ASSERT_EQUAL_INT8(0, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(1, C); 
...
void test_sll_shortoff_y(void){
  ...
  TEST_ASSERT_EQUAL_INT8(3, sll_shortoff_y(instr));
  TEST_ASSERT_EQUAL_INT8(0x4C, MEM_READ_BYTE(0X2B22) ); 
  TEST_ASSERT_EQUAL_INT8(0, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(1, C); 
...
void test_sll_longoff_y(void){
  ...
  TEST_ASSERT_EQUAL_INT8(4, sll_longoff_y(instr));
  TEST_ASSERT_EQUAL_INT8(0x4C, MEM_READ_BYTE(0X3C22) ); 
  TEST_ASSERT_EQUAL_INT8(0, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(1, C); 
...
void test_sll_shortoff_sp(void){
  SET_SP(0x2B11);
  N = 1;
  Z = 1;
  uint8_t instr[] = {0XFB, 0X11};
  ...
  TEST_ASSERT_EQUAL_INT8(2, sll_shortoff_sp(instr));
  TEST_ASSERT_EQUAL_INT8(0x4C, MEM_READ_BYTE(0X2B22) ); 
  TEST_ASSERT_EQUAL_INT8(0, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(1, C);  
...
void test_sll_shortptr_w(void){ 
  ...
  TEST_ASSERT_EQUAL_INT8(3, sll_shortptr_w(instr));
...
void test_sll_longptr_w(void){ 
  ...
  TEST_ASSERT_EQUAL_INT8(4, sll_longptr_w(instr));
  TEST_ASSERT_EQUAL_INT8(0x4C, MEM_READ_BYTE(0xAABB) ); 
  TEST_ASSERT_EQUAL_INT8(0, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(1, C); 
...
void test_sll_shortptr_w_x(void){ 
  SET_X(0X11);
  N = 1;
  Z = 1;
  uint8_t instr[] = {0XFB, 0X13};
  ...
  TEST_ASSERT_EQUAL_INT8(3, sll_shortptr_w_x(instr));
...
void test_sll_longptr_w_x(void){ 
  SET_X(0x11);
  N = 1;
  Z = 1;
  ...
  TEST_ASSERT_EQUAL_INT8(4, sll_longptr_w_x(instr));
...
void test_sll_shortptr_w_y(void){
  ...
  TEST_ASSERT_EQUAL_INT8(3, sll_shortptr_w_y(instr));
  TEST_ASSERT_EQUAL_INT8(0x4C, MEM_READ_BYTE(0x1122) ); 
  TEST_ASSERT_EQUAL_INT8(0, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(1, C); 
