...
void setUp(void){
  ...
  /**
        0xA6    1010  0110    
                bit 0 is set to C, then shift right one time . but bit 7 unchanged
        0xD3    1101  0011
...
void test_sra_longmem(void){
  ...
  MEM_WRITE_BYTE( 0x1101,  0x67);
  
  TEST_ASSERT_EQUAL_INT8(4, sra_longmem(instr));
  TEST_ASSERT_EQUAL_INT8(0x33, MEM_READ_BYTE(0x1101) ); 
  TEST_ASSERT_EQUAL_INT8(0, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(1, C); 
}
...
void test_sra_x(void){
  ...
  TEST_ASSERT_EQUAL_INT8(0xD3, MEM_READ_BYTE(0X102B) ); 
  TEST_ASSERT_EQUAL_INT8(1, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(0, C);  
}
...
void test_sra_shortoff_x(void){
  ...
  TEST_ASSERT_EQUAL_INT8(0xD3, MEM_READ_BYTE(0X2B22) ); 
  TEST_ASSERT_EQUAL_INT8(1, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(0, C); 
}
...
void test_sra_longoff_x(void){
  ...
  TEST_ASSERT_EQUAL_INT8(0xD3, MEM_READ_BYTE(0X3C22) ); 
  TEST_ASSERT_EQUAL_INT8(1, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(0, C); 
}
...
void test_sra_shortptr_w(void){ 
  ...
  TEST_ASSERT_EQUAL_INT8(0xD3, MEM_READ_BYTE(0xAABB) ); 
  TEST_ASSERT_EQUAL_INT8(1, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(0, C); 
}
...
void test_sra_shortptr_w_x(void){ 
  ...
  TEST_ASSERT_EQUAL_INT8(0xD3, MEM_READ_BYTE(0x1122) ); 
  TEST_ASSERT_EQUAL_INT8(1, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(0, C); 
}
...
void test_sra_longptr_w_x(void){ 
  ...
  TEST_ASSERT_EQUAL_INT8(0xD3, MEM_READ_BYTE(0xAACC) ); 
  TEST_ASSERT_EQUAL_INT8(1, N);  
  TEST_ASSERT_EQUAL_INT8(0, Z); 
  TEST_ASSERT_EQUAL_INT8(0, C); 
}
