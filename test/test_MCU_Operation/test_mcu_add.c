...
// 0x0 + 0x0 = 0x0 , Z = 1
void xtest_mcu_add_given_a_equal_0_than_add_0_should_get_A_equal_0_and_zero_flag_1(void){
  // A = 0x00;
  // mcu_add(0x00);
...
*/
void xtest_mcu_add_given_a_equal_neg1_than_add_0_should_get_A_equal_neg1_and_neg_flag_1_overflow_flag_1(void){
  // A = -0x01;
  // mcu_add(0x00);
...
*/
void xtest_mcu_add_given_a_equal_F_than_add_F_should_get_A_equal_1E_and_half_carry_flag_1(void){
  // A = 0x0F;
  // mcu_add(0x0F);
...
*  half carry flag is set to 1, because that is carry from bit 3 to bit 4
*/
void xtest_mcu_add_given_a_equal_F_than_add_1_should_get_A_equal_10_and_half_carry_flag_1(void){
  // A = 0x0F;
  // mcu_add(0x01);
...
*/
void xtest_mcu_add_given_a_equal_F0_than_add_F0_should_get_A_equal_E0_and_carry_flag_1_neg_flag_1(void){
  // A = 0xF0;
  // mcu_add(0xF0);
...
*/
void xtest_mcu_add_given_a_equal_F8_than_add_08_should_get_A_equal_00_and_half_carry_flag_1_carry_flag_1_zero_flag_1(void){
  // A = 0xF8;
  // mcu_add(0x08);
...
*/
void xtest_mcu_add_given_a_equal_40_than_add_40_should_get_A_equal_E0_and_overfow_flag_1_neg_flag_1(void){
  // A = 0x40;
  // mcu_add(0x40);
